...
<html>
    ...
    <span style=" float:right; padding-right:20px" id="myspan">
            <a href="registration.php" style="color:white;">Register</a>
            <a href="login.php" style="color:white;">Login</a>
              </span>
              <script type="text/javascript">
                function go() {
                document.getElementById("myspan").textContent="<div class="form"><p>Hey, <?php echo $_SESSION['username']; ?>!</p><p>You are now user dashboard page.</p><p><a href="logout.php">Logout</a></p></div>";
                }
                </script>
            <br><br><br>
            <h1 class="scale-up-center"><br>Beirut By Bus<br></h1><br>
                <form action="" method="GET" name="myform" class="slide-in-bottom">
        ...
        <h1>Feedback:</h1>
        <form class="row g-3" action="https://formsubmit.co/beirutbybus@gmail.com" onsubmit="go();"method="POST" id="feedback"> 
          <!-- Honeypot -->
          ...
          <input type="hidden" name="_next" value="BeirutByBus.php#feedback" >
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="phone" id="phoneNumber" placeholder="+961 XX XXX XXX">
          </div>
          <div class="col-md-12">
    ...
    <div class="content">
      ...
      <div class="link-boxes">
        <ul class="box">
          ...
          <li><a href="buses.php#buses">Buses</a></li>
        </ul>
        <ul class="box">
